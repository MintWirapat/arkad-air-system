        ...
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-300 p-12 space-y-8">
                        ...
                        <div className="grid grid-cols-[200px_1fr] gap-8 items-center">
                            ...
                            <input
                                ...
                                placeholder="ชื่อ"
                                className="w-full px-0 py-3 border-0 border-b border-gray-200 focus:outline-none focus:border-gray-400 placeholder-gray-300"
                            />
                        </div>

                        {/* แถวที่ 2: อีเมล */}
                        <div className="grid grid-cols-[200px_1fr] gap-8 items-center">
                            <label className="text-base text-gray-900">อีเมล</label>
                            <input
                                type="email"
                                name="email"
                        ...
                        <div className="grid grid-cols-[200px_1fr] gap-8 items-center">
                            <label className="text-base text-gray-900">หมายเลขโทรศัพท์</label>
                            <input
                                type="tel"
                                name="phone"
                        ...
                        {/* แถวที่ 4: หัวข้อ */}
                        <div className="grid grid-cols-[200px_1fr] gap-8 items-center">
                            <label className="text-base text-gray-900">หัวข้อ</label>
                            <input
                                type="text"
                                name="topic"
                        ...
                        <div className="pt-8">
                            <button
                                ...
                                className="w-full bg-blue-500 text-white py-4 rounded-full hover:bg-blue-600 transition-colors font-medium text-lg shadow-lg"
                            >
                                ส่ง
                            </button>
                            <p className="text-center text-sm text-blue-600 pt-2">ตอบกลับภายใน 1 - 3 วัน</p>
                        </div>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
                <div className="text-center mb-16">
                    <h2 className="text-3xl mb-4">เวลาทำการ</h2>
                    <p className="text-3xl mb-4">จันทร์ - ศุกร์ เวลา 09:00-17:00 น.</p>
                    <p className="text-3xl mb-4">หยุดทำการ</p>
                    <p className="text-3xl mb-4">เสาร์-อาทิตย์ และวันหยุดนักขัตฤกษ์</p>
                </div>
            </div>
            {/* เส้นขีดกั้น */}
            <div className="border-t-2 border-gray-300"></div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                <p className="text-gray-800">095 938 0230</p>
                            </div>

                            <div className="flex items-center space-x-4">
                                <Mail className="w-6 h-6 text-gray-800 flex-shrink-0" />
                                <p className="text-gray-800">arkaddee.official@gmail.com</p>
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                <p className="font-semibold text-gray-900 mb-2">แผนที่</p>
